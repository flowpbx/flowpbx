...
- [ ] Create `internal/media/proxy.go` — UDP socket pool for RTP relay (configurable port range, default 10000-20000)
- [ ] Implement RTP session allocation: allocate a pair of ports (RTP + RTCP) per call leg
