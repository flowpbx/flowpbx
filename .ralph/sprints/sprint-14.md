...
- [ ] Organize voicemail files by box: `$DATA_DIR/voicemail/box_{id}/msg_{id}.wav`
- [ ] Store voicemail box greetings at `$DATA_DIR/greetings/box_{id}.wav`
- [ ] Implement MWI: send SIP NOTIFY to extension linked via `notify_extension_id` on new message
...
- [ ] Create voicemail box CRUD API: `GET/POST/PUT/DELETE /api/v1/voicemail-boxes`
